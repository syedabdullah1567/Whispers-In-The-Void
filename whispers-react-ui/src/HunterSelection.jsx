    ...
    return (
        <div className="selection-screen">
                ...
                {hunters.map(h => (
                    <div key={h.hunter_id} className="hunter-pokemon-card" onClick={() => navigate('/location-select', { state: { hunter: h } })}>
                        <div className="card-inner">
                            <div className="card-rank">RANK: {h.rank}</div>
                            ...
                            <div className="card-info">
                                ...
                                <div className="hunter-stats">
                                    <div className="stat-line"><span>STAMINA</span><div className="bar"><div className="fill" style={{width: '70%'}}></div></div></div>
                                    <div className="stat-line"><span>PSI-SYNC</span><div className="bar"><div className="fill" style={{width: '45%'}}></div></div></div>
                                </div>
            ...
            <style>{`
                ...
                .card-rank { font-size: 10px; background: #ff4d4d; color: #000; font-weight: bold; padding: 2px 8px; align-self: flex-start; margin: 5px; }
                ...
                .stat-line { font-size: 9px; color: #888; display: flex; align-items: center; justify-content: space-between; margin-bottom: 5px; }
